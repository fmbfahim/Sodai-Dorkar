...
// Adjust path to reach src/Core and config
...
try { 
    ...
    echo "Starting Phase 2 Migration (Web Mode)...<br>";
    ...
    echo "Table 'dm_allocations' created.<br>";

    echo "Migration Completed Successfully!<br>";

} catch (PDOException $e) {
    die("Migration Failed: " . $e->getMessage() . "<br>");
} catch (Exception $e) {
